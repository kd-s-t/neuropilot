...
from routers import auth_router, eeg_router, websocket_router, training_router, machine_router, suggestions_router, ai_router, tello_router, robotic_router, test_camera_router
...
async def process_machine_controls():
    """Match headband band powers (from muselsl/pylsl) to bound controls via relative pattern match against training session signatures."""
    import asyncio
